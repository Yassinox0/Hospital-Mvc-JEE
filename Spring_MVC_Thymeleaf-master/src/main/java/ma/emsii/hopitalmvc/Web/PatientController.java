package ma.emsii.hopitalmvc.Web;

import jakarta.validation.Valid;
import lombok.AllArgsConstructor;
import ma.emsii.hopitalmvc.Repository.PatientRepository;
...
@GetMapping("/index") //  Return a View called Patient HTML
...
){ //  Method that return a String and then it's stocked in the model with a model type
...
@GetMapping("/delete") //Execution of Delete Method
